...
// Картинка будет правильно собираться и работать на Railway
import creationImage from './assets/images/creation_halftone_1782994945274.jpg';
        ...
        <AnimatePresence mode="wait">
          {activeSection === 'home' && (
            ...
            >
              <Hero
                onOpenContact={handleOpenContact}
                creationImageSrc={creationImage}
              />
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            <span className="font-display font-extrabold text-2xl tracking-tight text-black flex items-center gap-1.5">
              NEXORA
              <span className="text-[10px] font-sans font-medium align-super relative -top-2">
                ®
              </span>
            </span>

            <p className="mt-4 text-xs text-black/50 max-w-sm leading-relaxed">
              We collaborate with forward-thinking visionaries to translate bold
              concepts into high-scale digital realities. We value deep intention
              over mechanical clutter.
            </p>
          ...
          <div>
            <span className="font-mono text-[10px] uppercase tracking-wider text-black/40 block mb-4">
              Focus areas
            </span>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-black/60 font-semibold">
              <li>
                <span className="text-black/40 font-mono">LDN:</span> 44 Great
                Windmill St
              </li>

              <li>
                <span className="text-black/40 font-mono">NYC:</span> 512
                Broadway, Soho
              </li>

              <li>
                <span className="text-black/40 font-mono">TYO:</span> Shibuya
                2-Chome
              </li>
